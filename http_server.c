...
void httpd_handler(struct evhttp_request *req, void *arg) {
    ...
    //http://127.0.0.1:8080/?username=gailun&passwd=123
...
void login_handler(struct evhttp_request *req, void *arg) 
{
    ...
    char *response_data = "{\"result\":\"ok\", \"recode\":0}";
...
int main(int argc, char *argv[]) 
{
    ...
    //printf("httpd = %d, httpd_option_timeout = %d\n", (int)httpd, httpd_option_timeout);
